{#-
  ...
  NOTE: Some email clients strip out <head> and <style>
  tags from emails, so it's best to have your CSS written
  inline within your markup.
  See: https://templates.mailchimp.com/resources/inline-css/
-#}
