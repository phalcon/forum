...
<html lang="en">
	<head>
		...
		{{- stylesheet_link("css/theme.css?v=2.0.1", true) -}}
		{{- stylesheet_link("css/editor.css?v=2.0.1", true) -}}
		{{- stylesheet_link("css/diff.css?v=2.0.1", true) -}}
		{{- stylesheet_link("css/style.css?v=2.0.1", true) -}}
	</head>
	<body>
		{{ content() }}
		...
		{{ javascript_include("js/editor.js?v=2.0.1") }}
		{{ javascript_include("js/forum.js?v=2.0.1") }}
		{{ javascript_include("js/gs.js?v=2.0.1") }}
