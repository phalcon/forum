	...
	{%- if post.accepted_answer == 'Y' -%}
		<div class="bs-callout bs-callout-success">
			...
			<p>This post is marked as solved. If you think the information contained on this thread must be part of the
				official documentation, please contribute submitting a <a href="https://help.github.com/articles/creating-a-pull-request">pull request</a> to its <a href="{{ config.site.repo }}">repository</a>.
			</p>
		</div>
	{%- endif -%}
{%- endif -%}
